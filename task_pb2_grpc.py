...
class TaskManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetTasksForUser = channel.unary_stream(
                '/TaskManager/GetTasksForUser',
                request_serializer=task__pb2.UserRequest.SerializeToString,
...
def add_TaskManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetTasksForUser': grpc.unary_stream_rpc_method_handler(
                    servicer.GetTasksForUser,
                    request_deserializer=task__pb2.UserRequest.FromString,
...
class TaskManager(object):
    ...
    def GetTasksForUser(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/TaskManager/GetTasksForUser',
            task__pb2.UserRequest.SerializeToString,
