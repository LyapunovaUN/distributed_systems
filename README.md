...
---
Вот полностью готовый блок в **Markdown**, аккуратно оформленный — можешь просто скопировать и вставить 👇
...
* **`task.proto`**
  ...
  Описывает методы сервиса и структуры сообщений.

* **`tasks_db`**
  Имитация базы данных (список задач, хранящийся в оперативной памяти).
