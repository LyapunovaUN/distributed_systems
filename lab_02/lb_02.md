...
Первоначально планировалось использование сервиса reqres.in, однако из-за ограничений соединения и недоступности сервиса из российской сети был использован альтернативный тестовый API — Postman Echo.
...
Сервер успешно обработал запрос и вернул ответ со статусом:

* **200 OK**

В теле ответа сервер вернул отправленные JSON-данные пользователя:
...
Также в ответе присутствовали HTTP-заголовки сервера и информация о типе содержимого `application/json`.

📷 Скриншот выполнения запроса:
<img width="948" height="896" alt="image" src="https://github.com/user-attachments/assets/6299d3f3-aabe-4d56-8687-f55d9b25df5f" />
